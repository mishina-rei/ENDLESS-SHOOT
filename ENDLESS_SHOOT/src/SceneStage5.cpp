...
void SceneStage5::Init()
{
	...
	Vector3 enemyPositions[] = {
		Vector3(-15.0f, 1.0f, -15.0f), // 対角線上の奥
		Vector3(0.0f, 1.0f, 0.0f),     // 中央
		Vector3(10.0f, 1.0f, -10.0f),  // 右奥
		Vector3(15.0f, 1.0f, 5.0f),
		Vector3(-5.0f, 1.0f, 10.0f),
		Vector3(5.0f, 1.0f, -5.0f),
		Vector3(-10.0f, 1.0f, 5.0f),
	};
	...
	auto CreateBlock = [&](Vector3 pos, Vector3 scale) {
		...
		mr.color = Vector4(0.4f, 0.7f, 0.4f, 1.0f);
		world.AddComponent<MeshRenderer>(entity, mr);
	};

	CreateBlock(Vector3(5.0f, 1.5f, 5.0f), Vector3(2.0f, 3.0f, 10.0f));
	CreateBlock(Vector3(-5.0f, 1.5f, -5.0f), Vector3(2.0f, 3.0f, 10.0f));
	CreateBlock(Vector3(10.0f, 1.5f, 0.0f), Vector3(8.0f, 3.0f, 2.0f));
	CreateBlock(Vector3(0.0f, 1.5f, 10.0f), Vector3(2.0f, 3.0f, 2.0f));
	CreateBlock(Vector3(-10.0f, 1.5f, 5.0f), Vector3(2.0f, 3.0f, 2.0f));
	CreateBlock(Vector3(5.0f, 1.5f, -5.0f), Vector3(2.0f, 3.0f, 2.0f));
